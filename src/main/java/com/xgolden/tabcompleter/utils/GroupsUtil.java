...
public class GroupsUtil extends CustomConfig {
    ...
    public static void createGroupWithPermission(String permission) {
        ...
        config.set(GROUPS_ROOT_PATH +"."+ permission +"."+ "commands", Arrays.asList("default_command", "anothercommand"));
        saveConfig();
    }

    public static void deleteGroupWithPermission(String permission) {
        config.set(GROUPS_ROOT_PATH +"."+ permission, null);
        saveConfig();
    }
    ...
    public static void addCommandToGroup(String command, String permission) {
        ...
        config.set(GROUPS_ROOT_PATH +"."+ permission +"."+ "commands", _currentCommands);
        saveConfig();
    }
    ...
    public static void setToWhitelist(String permission, boolean bool) {
        config.set(GROUPS_ROOT_PATH +"."+ permission +"."+ "is_list_whitelist", bool);
        saveConfig();
    }

    public static boolean isWhitelist(String permission) {
        return config.getBoolean(GROUPS_ROOT_PATH +"."+ permission +"."+ "is_list_whitelist");
    }

    public static Set<String> getGroups() {
        return config.getConfigurationSection(GROUPS_ROOT_PATH).getKeys(false);
    }

    public static List<String> getCommandsForGroup(String permission) {
        return config.getStringList(GROUPS_ROOT_PATH +"."+ permission +"."+ "commands");
    }
